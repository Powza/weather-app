...
const weatherSlider = props => {
  ...
  function template() {
    ...
    if (props.day) {
      sliderInitialize = props.day.slice(1, 8).map((item, index) => {
        ...
        return (
          <div key={item.time}>
            ...
            >
              ...
              <span>
                <i className="fas fa-arrow-down" /> {Math.round(item.temperatureLow)} ° / <i className="fas fa-arrow-up" />{" "}
            ...
            <>
              <MicroModal
                ...
                children={handleClose => (
                  <div>
                    <div className={styles["modal__top"]} style={backgroundCondition}>
