...
const dailySlider = props => {
  ...
  const hourArray = () => {
    let newArray = checkHour.map(object =>
      moment.unix(object.time).format("M/D/YYYY")
    );
        ...
        <MicroModal
          ...
          trigger={handleOpen => (
            ...
            >
              ...
              moment.unix(item.time).format("dddd Do") ? (
                <div className={styles.date}>Today</div>
              ) : (
                <div className={styles.date}>
                  {moment.unix(item.time).format("ddd MMM Do")}
                </div>
              )}
              <WeatherIcon condition={item.icon} color="white" />
              <div className={styles.temp}>
                {Math.round(item.apparentTemperatureMax)} °{" "}
                <span>{Math.round(item.apparentTemperatureMin)} °</span>
              </div>
            ...
            <>
              <div className={styles["modal__top"]}>
                <div
                  ...
                  className={styles["modal__top__background"]}
                />
                <button
                ...
                moment.unix(item.time).format("dddd Do") ? (
                  ...
                  <h2 className={styles.date}>
                    {moment.unix(item.time).format("dddd, MMMM Do")}
                  </h2>
                )}
                <div className="row">
                  ...
                  <div className="col-6 col-xs-6 col-sm-6 col-md-3">
                    <div className={styles["modal__item"]}>
                      ...
                      <h4 className={styles["modal__item__title"]}>
                        Precipitation
                      </h4>
                ...
                >
                  <TabList className="tab-group">
                    ...
                    {hourArray().map((dataTime, index) => {
                      if (
                        dataTime === moment.unix(item.time).format("M/D/YYYY")
                      ) {
                        return (
                  ...
                  <TabPanel>
                    <ul>
                      ...
                      <li>
                        ...
                        <span>
                          {moment.unix(item.sunriseTime).format("h:mm a")}
                        </span>
                      </li>
                      <li>
                        <strong>Sunset</strong>{" "}
                        <span>
                          {moment.unix(item.sunsetTime).format("h:mm a")}
                        </span>
                      </li>
                      <li>
                      ...
                      <li>
                        ...
                        <span>{Math.round(item.dewPoint)} °</span>
                      </li>
                      <li>
                        <strong>Wind Gust</strong>{" "}
                        <span>{Math.round(item.windGust)} mph</span>
                      </li>
                      ...
                      <li>
                        ...
                        <span>
                          {item.uvIndex} at{" "}
                          {moment.unix(item.uvIndexTime).format("h:mm a")}
                        </span>
                      </li>
                      <li>
                      ...
                      <li>
                        <strong>Ozone</strong>{" "}
                        <span>{Math.round(item.ozone)} du</span>
                      </li>
                      <li>
                        <strong>Visibility</strong>{" "}
                        <span>{Math.round(item.visibility)} mi</span>
                      </li>
                    </ul>
                  </TabPanel>
