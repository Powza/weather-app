...
const dailySlider = props => {
  ...
  const hourArray = () => {
    let newArray = checkHour.map(object =>
      format(fromUnixTime(object.time), 'M/d/yyyy')
    );
        ...
        <MicroModal
          ...
          trigger={handleOpen => (
            ...
            >
              ...
              format(fromUnixTime(item.time), 'eeee Do') ? (
                <div className={styles.date}>Today</div>
              ) : (
                <div className={styles.date}>
                  {format(fromUnixTime(item.time), 'eee, MMM do')}
                </div>
              )}
                ...
                >
                  <TabList className="tab-group">
                    ...
                    {hourArray().map((dataTime, index) => {
                      if (
                        dataTime === format(fromUnixTime(item.time), 'M/d/yyyy')
                      ) {
                        return (
                  ...
                  <TabPanel>
                    <ul>
                      ...
                      <li>
                        ...
                        <span>
                          {format(fromUnixTime(item.sunriseTime), 'h:m a')}
                        </span>
                      </li>
                      <li>
                        <strong>Sunset</strong>{' '}
                        <span>
                          {format(fromUnixTime(item.sunsetTime), 'h:m a')}
                        </span>
                      </li>
                      <li>
                      ...
                      <li>
                        ...
                        <span>
                          {item.uvIndex} at{' '}
                          {format(fromUnixTime(item.uvIndexTime), 'hh:mm a')}
                        </span>
                      </li>
                      <li>
