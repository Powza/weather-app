...
const hourlySlider = props => {
  ...
  sliderInitialize = props.weather.hourly.data.map((item, index) => {
          ...
          children={handleClose => (
            <>
              ...
              <div className={styles["modal-body"]}>
                ...
                <ul>
                  <li>
                    <strong>Temperature</strong> <span>{Math.round(item.apparentTemperature)} °</span>
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>UV Index</strong> <span>{item.uvIndex}</span>
                  </li>
                  <li>
