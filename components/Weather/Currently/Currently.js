...
import { getDirection, calculatePressure, formatAsPercentage } from "../../../utils/calculateWeather";
          ...
          <div className={styles.now}>
            ...
            {props.daily && (
              <div className={styles["temp-lh"]}>
                {Math.round(props.daily.data[0].apparentTemperatureMax)} °{" "}
                <span>{Math.round(props.daily.data[0].apparentTemperatureMin)} °</span>
              </div>
            )}
          </div>
        </div>
              ...
              <ul className={[["list-unstyled"], styles["stats"]].join(" ")}>
                ...
                <li className="media">
                  ...
                  <div className="media-body">
                    Wind Speed
                    <h5>
                      {getDirection(props.currently.windBearing)} {Math.round(props.currently.windSpeed)} MPH
                    </h5>
                  </div>
                </li>
                <li className="media">
