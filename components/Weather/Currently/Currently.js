...
const currently = props => {
  return (
    <div className={styles.currently}>
      <div className={styles["alerts-box"]}>
        {props.alerts && <Alerts alert={props.alerts} />}
      </div>
              ...
              <ul className={[["list-unstyled"], styles["stats"]].join(" ")}>
                ...
                <li className="media">
                  ...
                  <div className="media-body">
                    Precipitation
                    <h5>
                      {formatAsPercentage(props.currently.precipProbability)}
                    </h5>
                  </div>
                </li>
                <li className="media">
                        ...
                        <div className={styles["modal-body"]}>
                          <ul>
                            ...
                            <li>
                              ...
                              <span>
                                {Math.round(props.currently.dewPoint)} °
                              </span>
                            </li>
                            <li>
                              <strong>Wind Gust</strong>{" "}
                              <span>
                                {Math.round(props.currently.windGust)} mph
                              </span>
                            </li>
                            <li>
                              <strong>Cloud Cover</strong>{" "}
                              <span>
                                {formatAsPercentage(props.currently.cloudCover)}
                              </span>
                            </li>
                            <li>
                              <strong>Air Pressure</strong>{" "}
                              <span>
                                {calculatePressure(props.currently.pressure)} in
                              </span>
                            </li>
                            <li>
                              <strong>Ozone</strong>{" "}
                              <span>
                                {Math.round(props.currently.ozone)} du
                              </span>
                            </li>
                            <li>
                              <strong>Visibility</strong>{" "}
                              <span>
                                {Math.round(props.currently.visibility)} mi
                              </span>
                            </li>
                              ...
                              <>
                                <li>
                                  ...
                                  <span>
                                    ...
                                    {Math.round(
                                      props.currently.nearestStormDistance
                                    )}{" "}
                                    mi
                                  </span>
                                </li>
